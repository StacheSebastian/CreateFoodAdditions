...
public class ItemInit {
    ...
    public static final RegistryObject<SchnitzelItem> SCHNITZEL = Registration.ITEMS.register("schnitzel", () -> new SchnitzelItem(new CheeseburgerItem.Properties().tab(CreateFoodAdditions.createfatab).food(new Food.Builder().effect(() -> new EffectInstance(Effects.SATURATION, 200 , 1), 0.005f).nutrition(12).saturationMod(1.1f).build())));
